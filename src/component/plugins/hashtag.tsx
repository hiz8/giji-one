...
export type HashTagState = Record<string, { hashtag: string; text: string }>;

type HashtagPluginProps = {
  onUpdateHashtagState: (hashtags: HashTagState) => void;
};
export function HashtagPlugin(props: HashtagPluginProps): JSX.Element | null {
